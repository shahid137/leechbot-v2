...
async def incoming_message_f(client, message):
    ...
    if rep_mess:
        ...
        await i_m_sefg.edit("<b>Hey buddy !</b>\n\n 🐈 <code>Reply with Direct Link</code>")
        return
    if dl_url is not None:
        ...
        aria_i_p = ''
        if not is_file:
            await i_m_sefg.edit_text("Extracting links... Please Wait Buddy...")
            # start the aria2c daemon
            aria_i_p = await aria_start()
            # LOGGER.info(aria_i_p)

        await i_m_sefg.edit_text("Downloading... Send /status To Check Progress")
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            if message_to_send != "":
                ...
                message_to_send = message_to_send + "\n\n" + "<b> #UPLOADS\n\n💫 Powered By : @The_Fourth_Minato</b>"
            else:
